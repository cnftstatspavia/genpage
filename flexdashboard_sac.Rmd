...
# traits <- readRDS("data/traits_sac.rds")
...
# Sidebar {data-width=70, .sidebar}
<ul id="sidebar_ul">
<li><a href="https://cnftstats.github.io/html/bcrc.html">BCRC</a></li>
<li><a href="https://cnftstats.github.io/html/mocossi.html">Mocossi</a></li>
<li id="currentProject"><a href="https://cnftstats.github.io/html/sac.html">SpaceApe</a></li>
<li><a href="https://cnftstats.github.io/html/chilledkongs.html">ChilledKongs</a></li>
</ul>
...
<!-- ### Linear scale -->
<!-- ```{r} -->
<!-- X <- DT[price < 6000 & asset_rarity < 650] -->
...
<!-- > Only listings < 6000 ada and with rarity < 650 are displayed. Try clicking on the legend or datapoints. -->
...
<!--                                                       "</br>Sc:", sc)))) + -->
<!--   geom_point(color = "steelblue4", alpha = .6) + -->
<!--   scale_x_continuous(n.breaks = 15, trans = "log2") + -->
<!--   scale_y_continuous(n.breaks = 20, trans = "log2") + -->
<!--   labs(x = "Rarity (log)", y = "Listing price (log)", color = "Market", shape = "Smart contract") + -->
<!--   theme(legend.title = element_text(size = 10)) -->
...
<!-- > Only listings < 6000 ada are displayed. Try clicking on the legend or datapoints. -->
...
X <- RAR[, .(asset_name = paste0("SpaceApe #", asset_number),
