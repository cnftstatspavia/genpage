...
DTE <- readRDS("data/DTE_sac.rds")

img_link <- "https://raw.githubusercontent.com/cnftstats/images/main/sac/sac"
...
<ul id="sidebar_ul">
  ...
  <li id="currentProject"><a href="https://cnftstats.github.io/sac.html">SpaceApe</a></li>
</ul>
...
X <- RAR[, .(asset_name, asset_rank, asset_rarity, asset_traits_num, asset_traits)]
datatable(X, class = 'compact stripe hover',
