...
DTE <- readRDS("data/DTE_borgs.rds")

img_link <- "https://raw.githubusercontent.com/cnftstats/images/main/borgs/borg"
...
<ul id="sidebar_ul">
  ...
  <li id="currentProject"><a href="https://cnftstats.github.io/borgs.html">BorgsClub</a></li>
...
X <- X[, .(trait_category, trait, img, price, sc, market, asset_traits_num, asset_traits)]
...
datatable(X, class = 'compact stripe hover',
          options = list(dom = "t",
                         ...
                         info = FALSE,
                         columnDefs = list(list(className = 'dt-right', targets = "_all"))),
          colnames = c("Trait</br>category", "Trait", "Asset", "Price", "Sc", "Market",
                       "Num.</br>traits", "Traits"),
          filter = "top",
          rownames = FALSE,
          escape = FALSE) %>%
...
X <- RAR[, .(asset_name, asset_traits_num, asset_traits)]
datatable(X, class = 'compact stripe hover',
          options = list(pageLength = 30,
                         ...
                         info = TRUE,
                         columnDefs = list(list(className = 'dt-right', targets = "_all"))),
          colnames = c("Asset", "Num.</br>traits", "Traits"),
          rownames = FALSE,
          escape = FALSE) %>%
  formatStyle(columns = 1:ncol(X), fontSize = '90%')
```
