...
img_link <- "https://raw.githubusercontent.com/cnftstats/images/main/adapes/adape"
...
<ul id="sidebar_ul">
  <li id="currentProject"><a href="https://cnftstats.github.io/adapes.html">Adapes</a></li>
...
X[price %between% c(2000, 5999), price_range := trunc(price/500)*500]
X[price %between% c(6000, 9999), price_range := trunc(price/2000)*2000]
...
X[price_range %between% c(2000, 5999), x_label := paste0(price_range, "-", price_range + (500-1))]
X[price_range %between% c(6000, 9999), x_label := paste0(price_range, "-", price_range + (2000-1))]
